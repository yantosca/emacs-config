  ...
  (color-theme-install
   '(color-theme-yantosca
     ...
     (modeline-mousable-minor-mode ((t (:foreground "dark cyan" :background "LemonChiffon"))))
      (italic ((t (:foreground "OrangeRed1" :italic t))))
     (bold-italic ((t (:foreground "OrangeRed1" :bold t :italic t))))
     (font-lock-builtin-face ((t (:foreground "OrangeRed1"))))
     ...
     (font-lock-function-name-face ((t (:foreground "OrangeRed1"))))
     ...
     (font-lock-reference-face ((t (:foreground "OrangeRed1"))))
     (font-lock-string-face ((t (:foreground "chartreuse1"))))
     (font-lock-type-face ((t (:foreground "DarkOrange1"))))
     (font-lock-warning-face ((t (:bold t :foreground "OrangeRed1" :weight bold))))
