...
Here are some settings for Emacs org-mode/
...
Scroll only one line when cursor is at the bottom of the screen (instead of finding the lastline suddenly in the middle)
